...
var _appCount = __webpack_require__(70);

var _appCount2 = _interopRequireDefault(_appCount);
...
var defaultStateCount = { value: 0, highlight: false, size: true };
var reducerCount = function reducerCount() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultStateCount;
...
var arrState = { arr: ['Android', 'iOS', 'NodeJS', 'React'], isAdding: true };

var reducerClass = function reducerClass() {
	var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : arrState;
	var action = arguments[1];
	...
	switch (action.type) {
		...
		case 'ADD_ITEM':
			return _extends({}, state, { arr: [].concat(_toConsumableArray(state.arr), [action.item]) });
		case 'REMOVE_ITEM':
			return _extends({}, state, { arr: state.arr.filter(function (e, i) {
...
_reactDom2.default.render(_react2.default.createElement(
	...
	{ store: (0, _redux.createStore)(reducerCount) },
	_react2.default.createElement(_appCount2.default, null)
...
*/
var aa=__webpack_require__(1),m=__webpack_require__(12),A=__webpack_require__(3),B=__webpack_require__(2),ca=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),ha=__webpack_require__(16),ia=__webpack_require__(17),C=__webpack_require__(6);
...
var _updown_points = __webpack_require__(71);

var _updown_points2 = _interopRequireDefault(_updown_points);
...
var AppCount = function (_Component) {
	_inherits(AppCount, _Component);

	function AppCount() {
		_classCallCheck(this, AppCount);

		return _possibleConstructorReturn(this, (AppCount.__proto__ || Object.getPrototypeOf(AppCount)).apply(this, arguments));
	}

	_createClass(AppCount, [{
		key: 'render',
		value: function render() {
			var color = this.props.myHighLight ? 'blue' : 'black';
			var size = this.props.mySize ? '18px' : '30px';
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(
				...
				_react2.default.createElement(_updown_points2.default, null)
			);
		}
	}]);
...
exports.default = (0, _reactRedux.connect)(mapStateToProps)(AppCount);
...
var _changeColor = __webpack_require__(72);

var _changeColor2 = _interopRequireDefault(_changeColor);

var _changeSize = __webpack_require__(73);

var _changeSize2 = _interopRequireDefault(_changeSize);
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          { onClick: function onClick() {
              _this2.props.dispatch({ type: 'UP' });
            } },
          'Up'
        ),
        _react2.default.createElement(
          'button',
          { onClick: this.onDownKey.bind(this) },
          'Down'
        ),
        _react2.default.createElement(_changeColor2.default, null),
        _react2.default.createElement(_changeSize2.default, null)
      );
    }
  }]);
...
var ChangeColor = function (_Component) {
  _inherits(ChangeColor, _Component);

  function ChangeColor() {
    _classCallCheck(this, ChangeColor);

    return _possibleConstructorReturn(this, (ChangeColor.__proto__ || Object.getPrototypeOf(ChangeColor)).apply(this, arguments));
  }
  ...
  _createClass(ChangeColor, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        'button',
        { onClick: function onClick() {
            return _this2.props.dispatch({ type: 'CHANGE_COLOR' });
          } },
        'Change Color'
      );
    }
...
var ChangeSize = function (_Component) {
    _inherits(ChangeSize, _Component);

    function ChangeSize() {
        _classCallCheck(this, ChangeSize);

        return _possibleConstructorReturn(this, (ChangeSize.__proto__ || Object.getPrototypeOf(ChangeSize)).apply(this, arguments));
    }

    _createClass(ChangeSize, [{
        key: 'changeTextSize',
        value: function changeTextSize() {
        ...
        value: function render() {
            return _react2.default.createElement(
                'button',
                { onClick: this.changeTextSize.bind(this) },
                'Change size'
            );
        }
    }]);
